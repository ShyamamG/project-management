...
//unsecured routes --- for those that do  not include access tokens
router.route("/register").post(userRegisterValidator(), validate, registerUser)
router.route("/login").post(userLoginValidator(), validate, login)

router.route("/verify-email/:verificationToken").get(verifyEmail)    
//will include verification token in the route as well as it is being asked in the controller too . whatever is present in the controller will also have to be included here.
...
//secure routes --- that has verifyJWT (the access tokens in it)
